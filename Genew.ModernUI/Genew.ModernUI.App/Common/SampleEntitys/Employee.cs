...
namespace Genew.ModernUI.App.Common.SampleDatas
{
    ...
    public sealed class Employee
    {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Somasegar",
            Justification = "It's his name.")]
        ...
        {
            get { return new[] { BillGates, SteveBallmer, Somasegar, ScottGuthrie }; }
        }
