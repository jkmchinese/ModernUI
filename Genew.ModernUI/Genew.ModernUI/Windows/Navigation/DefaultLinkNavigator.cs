...
namespace Genew.ModernUI.Windows.Navigation
{
    ...
    public class DefaultLinkNavigator
        : ILinkNavigator
    {
        private CommandDictionary m_commands = new CommandDictionary();
        private string[] m_externalSchemes = new string[] { Uri.UriSchemeHttp, Uri.UriSchemeHttps, Uri.UriSchemeMailto };
        ...
        public DefaultLinkNavigator()
        {
            ...
            this.m_commands.Add(new Uri("cmd://browseback"), NavigationCommands.BrowseBack);
            this.m_commands.Add(new Uri("cmd://refresh"), NavigationCommands.Refresh);

            // register application commands
            this.m_commands.Add(new Uri("cmd://copy"), ApplicationCommands.Copy);
        }
        ...
        {
            get { return this.m_externalSchemes; }
            set { this.m_externalSchemes = value; }
        }
        ...
        public virtual void Navigate(Uri uri, FrameworkElement source = null, string parameter = null)
        {
            ...
            ICommand command;
            if (this.m_commands != null && this.m_commands.TryGetValue(uri, out command))
            {
            ...
            else if (uri.IsAbsoluteUri && this.m_externalSchemes != null && this.m_externalSchemes.Any(s => uri.Scheme.Equals(s, StringComparison.OrdinalIgnoreCase)))
            {
