...
namespace ModernUI.Windows.Controls
{
    ...
    public class TransitioningContentControl : ContentControl
    {
        ...
        /// </summary>
        private bool m_allowIsTransitioningWrite;
        ...
        public bool IsTransitioning
        {
            ...
            private set
            {
                m_allowIsTransitioningWrite = true;
                SetValue(IsTransitioningProperty, value);
                m_allowIsTransitioningWrite = false;
        ...
        private static void OnIsTransitioningPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!source.m_allowIsTransitioningWrite)
            {
        ...
        /// </summary>
        private Storyboard m_currentTransition;
        ...
        {
            get { return m_currentTransition; }
            set
            {
                // decouple event
                if (m_currentTransition != null)
                {
                    m_currentTransition.Completed -= OnTransitionCompleted;
                }

                m_currentTransition = value;
