...
namespace Genew.ModernUI.Windows.Controls.BBCode
{
    ...
    internal abstract class Lexer
    {
        ...
        private readonly CharBuffer m_buffer;
        private readonly Stack<int> m_states;
        ...
        {
            this.m_buffer = new CharBuffer(value);
            this.m_states = new Stack<int>();
        }
