...
namespace ModernUI.ExtendedToolkit
{
    ...
    /// <value>The collapse storyboard.</value>
        ...
        /// <remarks>
        ///     The IsSelected property may not be changed when the
        ...
        ///     AccordionItem and the AccordionItem is currently selected.
        /// </remarks>
    ...
    /// </summary>
        ...
        public static RoutedEvent SelectedEvent = EventManager.RegisterRoutedEvent("Selected", RoutingStrategy.Bubble,
            typeof(RoutedEventHandler), typeof(AccordionItem));
        ...
        ///     Occurs when the accordionItem is unselected.
        /// </summary>
        public static RoutedEvent UnselectedEvent = EventManager.RegisterRoutedEvent("Unselected",
            RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(AccordionItem));
        ...
        internal virtual void StartAction()
        {
            ...
            {
                throw new InvalidOperationException("AccordionItem_StartAction_InvalidCall");
            }
            Action layoutAction;
                ...
                default:
                    {
                        string message = string.Format(
                            CultureInfo.InvariantCulture,
                            "AccordionItem_StartAction_InvalidAction" +
                            ScheduledAction);
    ...
    /// <remarks>AccordionItem is required to make this call.</remarks>
        ...
        [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "parent",
            Justification = "Following ItemsControl signature.")]
        [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "parentItemContainerStyle",
            Justification = "Following ItemsControl signature.")]
    ...
    /// <param name="args">Event arguments.</param>
        ...
        /// </summary>
        private readonly InteractionHelper _interaction;
