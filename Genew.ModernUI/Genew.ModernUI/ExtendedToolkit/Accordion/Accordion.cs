...
namespace Genew.ModernUI.ExtendedToolkit
{
    ...
    public class Accordion : ItemsControl, IUpdateVisualState
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Setting the ExpandDirection will set the expand direction
        ///     on the accordionItems.
        /// </remarks>
        ...
        private static void OnExpandDirectionPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                expandDirection != ExpandDirection.Right)
            {
                ...
                const string errorStr = "Accordion_OnExpandDirectionPropertyChanged_InvalidValue";
        ...
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Multi",
            Justification = "WPF has a MultiSelector class that will be used in the future.")]
        ...
        private static void OnSelectionModePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                newValue != AccordionSelectionMode.ZeroOrOne)
            {
                ...
                string message = string.Format(
                    CultureInfo.InvariantCulture,
                    "Accordion_OnSelectionModePropertyChanged_InvalidValue" +
                    newValue);
        ...
        private static void OnSelectedItemPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            else if (source._selectedItemNestedLevel == 0)
            {
                ...
                else
                {
                    ...
                    if (currentIndex < 0 || currentIndex > source.Items.Count ||
                        !newValue.Equals(source.Items[currentIndex]))
                    {
                        ...
                        IEnumerable<int> validIndices =
                            source.SelectedIndices.Where(
                                i => i >= 0 && i < source.Items.Count && newValue.Equals(source.Items[i]));
        ...
        private static void OnSelectionSequencePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                newValue != SelectionSequence.Simultaneous)
            {
                ...
                string errorStr = "Accordion_OnSelectionSequencepropertyChanged_InvalidValue";
                string message = string.Format(
                    CultureInfo.InvariantCulture,
                    errorStr,
                    newValue);
        ...
        private static void OnSelectedItemsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!accordion._isAllowedToWriteSelectedItems)
            {
                ...
                throw new InvalidOperationException("Accordion_OnSelectedItemsChanged_InvalidWrite");
            }
        }
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms", MessageId = "Indices",
            Justification = "Framework uses indices.")]
        ...
        private static void OnSelectedIndicesChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!accordion._isAllowedToWriteSelectedIndices)
            {
                ...
                throw new InvalidOperationException("Accordion_OnSelectedIndicesChanged_InvalidWrite");
            }
        }
        ...
        /// </summary>
        /// <remarks>
        ///     Either ContentTemplate or ItemTemplate is used.
        ///     Setting both will result in an exception.
        /// </remarks>
    ...
    /// </summary>
        ...
        public static readonly RoutedEvent SelectionChangedEvent = EventManager.RegisterRoutedEvent("SelectionChanged",
            RoutingStrategy.Bubble, typeof(SelectionChangedEventHandler), typeof(Accordion));
        ...
        protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
        {
            ...
            if (accordionItem != null)
            {
                ...
                AccordionItem.PreparePrepareHeaderedContentControlContainerForItemOverride(accordionItem, item, this,
                    ItemContainerStyle);
        ...
        ///     <see
        ///         cref="M:System.Windows.Controls.ItemsControl.PrepareContainerForItemOverride(System.Windows.DependencyObject,System.Object)" />
        ///     method.
        /// </summary>
        ...
        {
            UnselectItem(ItemContainerGenerator.IndexFromContainer(accordionItem),
                ItemContainerGenerator.ItemFromContainer(accordionItem));
        }
        ...
        private void UnselectItem(int index, object item)
        {
            ...
            AccordionItem container = index >= 0 && index < Items.Count
        ...
        {
            AccordionItem oldAccordionItem = oldIndex >= 0 && oldIndex < Items.Count
                ? ItemContainerGenerator.ContainerFromIndex(oldIndex) as AccordionItem
                : null;
            AccordionItem newAccordionItem = newIndex >= 0 && newIndex < Items.Count
                ? ItemContainerGenerator.ContainerFromIndex(newIndex) as AccordionItem
                : null;
            ...
            if (oldIndex != newIndex)
            {
                ...
                if (IsMaximumOneSelected || newIndex == -1)
                {
                    ...
                    {
                        AutomationPeer peer =
                            UIElementAutomationPeer.CreatePeerForElement(newAccordionItem);
                        if (peer != null)
                        {
                ...
                default:
                    {
                        string message = string.Format(
                            CultureInfo.InvariantCulture,
                            "Accordion_UnsupportedCollectionAction" +
                            e.Action);
        ...
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity",
            Justification = "Method is best kept coherent.")]
                ...
                case NotifyCollectionChangedAction.Add:
                    {
                        if (IsMaximumOneSelected)
                        {
                            ...
                            if (SelectedItem != null && e.NewItems.Count != 1 ||
                                ((int)e.NewItems[0] < Items.Count && !Items[(int)e.NewItems[0]].Equals(SelectedItem)))
                            {
                                // will always lead to manipulation of the collection
                                throw new InvalidOperationException(
                                    "Accordion_InvalidManipulationOfSelectionCollections");
                ...
                case NotifyCollectionChangedAction.Remove:
                    {
                        ...
                        {
                            if (SelectedIndex < Items.Count && Items[SelectedIndex].Equals(SelectedItem) &&
        ...
        /// </summary>
        /// <param name="nonCandidateIndex">
        ///     Index that should not be considered if
        ///     possible.
        /// </param>
        /// <returns>
        ///     An item that should be selected. This could be nonCandidateIndex,
        ...
        private int ProposeSelectedIndexCandidate(int nonCandidateIndex)
        {
            ...
            IEnumerable<int> validIndices =
                SelectedIndices.Where(i => i != nonCandidateIndex && (item == null || !item.Equals(Items[i])));
        ...
        /// </summary>
        /// <remarks>
        ///     If the Accordion SelectionMode is OneOrMore or ZeroOrMore all
        ...
        ///     the last AccordionItem would remain selected.
        /// </remarks>
        ...
        /// </param>
        /// <remarks>
        ///     This event is raised after the changes to the collection
        ///     have been processed.
        /// </remarks>
        ...
        [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "item",
            Justification =
                "Passing the AccordionItem leads to a better API if we wish to change modifier to protected in the future."
            )]
        ...
        /// <returns>
        ///     True if the item is allowed to proceed without scheduling,
        ///     false if the item needs to wait for a signal to execute the action.
        /// </returns>
        ...
        /// <remarks>
        ///     An AccordionItem should always signal a finish, for this call
        ///     will start the next scheduled action.
        /// </remarks>
        internal virtual void OnActionFinish(AccordionItem item)
        {
            if (SelectionSequence == SelectionSequence.CollapseBeforeExpand)
            {
                lock (this)
                {
                    ...
                    {
                        throw new InvalidOperationException("Accordion_OnActionFinish_InvalidFinish");
                    }
        ...
        /// </summary>
        /// <remarks>
        ///     An AccordionItem is should always signal that it is
        ...
        private void StartNextAction()
        {
            ...
            AccordionItem next =
                _scheduledActions.FirstOrDefault(item => item.ScheduledAction == AccordionAction.Collapse);
            if (next == null)
            {
        ...
        private void LayoutChildren()
        {
            ...
            if (root != null && ItemsControlHelper.ItemsHost != null)
            {
                ...
                else if (IsShouldFillHeight)
                {
                    ...
                    // calculate targetsize per selected item. This is redistribution.
                    targetSize.Height = SelectedItems.Count > 0
                        ? targetSize.Height / SelectedItems.Count
                        : targetSize.Height;
                }
            ...
            if (panel != null)
            {
                switch (ExpandDirection)
                {
                    ...
                    case ExpandDirection.Up:
                        ...
                        panel.VerticalAlignment = ExpandDirection == ExpandDirection.Down
                    ...
                    case ExpandDirection.Right:
                        ...
                        panel.HorizontalAlignment = ExpandDirection == ExpandDirection.Left
