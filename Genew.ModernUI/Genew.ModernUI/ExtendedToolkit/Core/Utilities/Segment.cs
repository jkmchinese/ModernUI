...
namespace ModernUI.ExtendedToolkit.Utilities
{
    internal struct Segment
    {
        ...
        public bool IsEmpty
        {
            get { return DoubleHelper.AreVirtuallyEqual(_p1, _p2) && (_isP1Excluded || _isP2Excluded); }
        }
        ...
        public bool IsPoint
        {
            get { return DoubleHelper.AreVirtuallyEqual(_p1, _p2); }
        }
        ...
        public double Slope
        {
            get { return (P2.X == P1.X) ? double.NaN : (P2.Y - P1.Y) / (P2.X - P1.X); }
        }
        ...
        public override string ToString()
        {
            ...
            {
                s = s + ": " + _p1 + (_isP1Excluded ? " (excl)" : " (incl)")
                    + " to " + _p2 + (_isP2Excluded ? " (excl)" : " (incl)");
            }
