...
namespace Genew.ModernUI.ExtendedToolkit.Primitives
{
    ...
    public abstract class UpDownBase<T> : InputBase, IValidateInput
    {
        ...
        {
            get { return (MouseWheelActiveTrigger)GetValue(MouseWheelActiveTriggerProperty); }
        ...
        public static readonly DependencyProperty
            MouseWheelActiveOnFocusProperty = DependencyProperty.Register("MouseWheelActiveOnFocus", typeof(bool),
...
#pragma warning restore 618
        ...
        protected override void OnInitialized(EventArgs e)
        {
            ...
            bool updateValueFromText =
                ...
                && (object.Equals(Value, ValueProperty.DefaultMetadata.DefaultValue));
        ...
        private bool SyncTextAndValueProperties(bool updateValueFromText, string text, bool forceTextUpdate)
        {
            ...
            try
            {
                ...
                if (!_isTextChangedFromUI)
                {
                    ...
                    bool shouldKeepEmpty = !forceTextUpdate && string.IsNullOrEmpty(Text) &&
