/*******************************************************************
* 版权所有： 深圳市震有科技有限公司
* 文件名称： RoutedPropertyChangingEventArgs.cs
* 作   者： chenzhifen
            ...
            set
            {
                ...
                else if (value)
                {
                    throw new InvalidOperationException(
                        //Properties.Resources.RoutedPropertyChangingEventArgs_CancelSet_InvalidOperation);
                        "RoutedPropertyChangingEventArgs_CancelSet_InvalidOperation");
                }
            }
        }
