...
namespace ModernUI.ExtendedToolkit
{
    ...
    public class AutoCompleteBox : Control, IUpdateVisualState
    {
        ...
        /// </summary>
        private WeakEventListener<AutoCompleteBox, object, NotifyCollectionChangedEventArgs>
        ...
        [SuppressMessage("Microsoft.Usage", "CA2208:InstantiateArgumentExceptionsCorrectly",
            Justification = "MinimumPrefixLength is the name of the actual dependency property.")]
        private static void OnMinimumPrefixLengthPropertyChanged(DependencyObject d,
        ...
        private static void OnMinimumPopulateDelayPropertyChanged(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newValue < 0)
            {
                ...
                throw new ArgumentException(
                    string.Format(CultureInfo.InvariantCulture,
                        "AutoComplete_OnMinimumPopulateDelayPropertyChanged_InvalidValue, newValue"), "value");
            }
        ...
        /// </summary>
        /// <value>
        ///     The <see cref="T:System.Windows.DataTemplate" /> used to
        ...
        private static void OnMaxDropDownHeightPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newValue < 0)
            {
                ...
                throw new ArgumentException(
                    string.Format(CultureInfo.InvariantCulture,
                        "AutoComplete_OnMaxDropDownHeightPropertyChanged_InvalidValue, e.NewValue"), "value");
            }
 ...
 removed,
        ...
        private static void OnSearchTextPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!source._allowWrite)
            {
                ...
                throw new InvalidOperationException("AutoComplete_OnSearchTextPropertyChanged_InvalidWrite");
                //Properties.Resources.AutoComplete_OnSearchTextPropertyChanged_InvalidWrite);
            }
        }
        ...
        ///     <see cref="F:System.Windows.Controls.AutoCompleteFilterMode.StartsWith" />.
        /// </value>
        ...
        /// <param name="e">Event arguments.</param>
        [SuppressMessage("Microsoft.Usage", "CA2208:InstantiateArgumentExceptionsCorrectly",
            Justification = "The exception will be thrown when the CLR setter is used in most situations.")]
        private static void OnFilterModePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                mode != AutoCompleteFilterMode.StartsWithOrdinalCaseSensitive)
            {
                ...
                throw new ArgumentException("AutoComplete_OnFilterModePropertyChanged_InvalidValue", "value");
            }
        ...
        public static readonly RoutedEvent TextChangedEvent = EventManager.RegisterRoutedEvent("TextChanged",
            RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(AutoCompleteBox));
...
#else
        public static readonly RoutedEvent PopulatingEvent = EventManager.RegisterRoutedEvent("Populating",
            RoutingStrategy.Bubble, typeof(PopulatingEventHandler), typeof(AutoCompleteBox));
...
#else
        public static readonly RoutedEvent PopulatedEvent = EventManager.RegisterRoutedEvent("Populated",
            RoutingStrategy.Bubble, typeof(PopulatedEventHandler), typeof(AutoCompleteBox));
...
#else
        public static readonly RoutedEvent DropDownOpeningEvent = EventManager.RegisterRoutedEvent("DropDownOpening",
            RoutingStrategy.Bubble, typeof(RoutedPropertyChangingEventHandler<bool>), typeof(AutoCompleteBox));
        ...
        public static readonly RoutedEvent DropDownOpenedEvent = EventManager.RegisterRoutedEvent("DropDownOpened",
            RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<bool>), typeof(AutoCompleteBox));
...
#else
        public static readonly RoutedEvent DropDownClosingEvent = EventManager.RegisterRoutedEvent("DropDownClosing",
            RoutingStrategy.Bubble, typeof(RoutedPropertyChangingEventHandler<bool>), typeof(AutoCompleteBox));
        ...
        public static readonly RoutedEvent SelectionChangedEvent = EventManager.RegisterRoutedEvent("SelectionChanged",
            RoutingStrategy.Bubble, typeof(SelectionChangedEventHandler), typeof(AutoCompleteBox));
        ...
        /// </summary>
        /// <value>
        ///     The <see cref="T:System.Windows.Data.Binding" /> object used
        ///     when binding to a collection property.
        /// </value>
        public Binding ValueMemberBinding
        {
            get { return _valueBindingEvaluator != null ? _valueBindingEvaluator.ValueBinding : null; }
        ...
        {
            get { return (ValueMemberBinding != null) ? ValueMemberBinding.Path.Path : null; }
...
#else
            RoutedPropertyChangingEventArgs<bool> args =
                new RoutedPropertyChangingEventArgs<bool>(IsDropDownOpenProperty, oldValue, false, true,
                    DropDownClosingEvent);
#endif
...
#else
            RoutedPropertyChangingEventArgs<bool> args =
                new RoutedPropertyChangingEventArgs<bool>(IsDropDownOpenProperty, oldValue, true, true,
        ...
        {
            AutoCompleteBoxAutomationPeer peer =
                UIElementAutomationPeer.FromElement(this) as AutoCompleteBoxAutomationPeer;
            if (peer != null)
            {
        ...
        /// </summary>
        /// <param name="e">
        ///     A <see cref="T:System.Windows.RoutedEventArgs" />
            ...
            if (_view.Count > 0)
            {
                if (IsTextCompletionEnabled && TextBox != null && userInitiated)
                {
                    ...
                    if (selectionStart == text.Length && selectionStart > _textSelectionStart)
                    {
                        ...
                        object top = FilterMode == AutoCompleteFilterMode.StartsWith ||
        ...
        private object TryGetMatch(string searchText, ObservableCollection<object> view,
        ...
        private void OnItemsSourceChanged(IEnumerable oldValue, IEnumerable newValue)
        {
            ...
            {
                _collectionChangedWeakEventListener =
                    new WeakEventListener<AutoCompleteBox, object, NotifyCollectionChangedEventArgs>(this);
                _collectionChangedWeakEventListener.OnEventAction =
                    (instance, source, eventArgs) => instance.ItemsSourceCollectionChanged(source, eventArgs);
                _collectionChangedWeakEventListener.OnDetachAction =
        ...
        private void ItemsSourceCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.Action == NotifyCollectionChangedAction.Add && e.NewItems != null &&
                _items.Count >= e.NewStartingIndex)
            {
        ...
        internal virtual void UpdateVisualState(bool useTransitions)
        {
            ...
            VisualStateManager.GoToState(this,
                IsDropDownOpen ? VisualStates.StatePopupOpened : VisualStates.StatePopupClosed, useTransitions);
