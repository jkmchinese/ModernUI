/*******************************************************************
* 版权所有： 深圳市震有科技有限公司
* 文件名称： BusyIndicator.cs
* 作   者： chenzhifen
* 创建日期： 2013-12-17 17:47:48
* 文件版本： 1.0.0.0
* 修改时间：             修改人：                修改内容：
*******************************************************************/
...
namespace ModernUI.ExtendedToolkit
{
    ...
    public class BusyIndicator : ContentControl
    {
        ...
        /// </summary>
        private readonly DispatcherTimer m_displayAfterTimer = new DispatcherTimer();
        ...
        {
            m_displayAfterTimer.Tick += DisplayAfterTimerElapsed;
        }
